...
def base_opts() -> dict:
    opts = {
        ...
        # Preferisce stream DASH (file unico HTTP) rispetto a HLS (m3u8 segmentato)
        # Gli stream HLS hanno URL con scadenza breve → 403 sui frammenti
...
# Selettori DASH-first: escludono HLS (m3u8) che scade rapidamente → 403 sui frammenti.
# "bestaudio[protocol^=http]" forza stream scaricabili in un unico file HTTP.
_DASH_AUDIO = (
